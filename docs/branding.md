...
|---|---|---|---|
| `icon16.png` | 16×16 | `make-icons.py` | `extension/icons/`, `Store Upload/2-Store-listing/Icons/` |
| `icon32.png` | 32×32 | `make-icons.py` | `extension/icons/`, `Store Upload/2-Store-listing/Icons/` |
| `icon48.png` | 48×48 | `make-icons.py` | `extension/icons/`, `Store Upload/2-Store-listing/Icons/` |
| `icon128.png` | 128×128 | `make-icons.py` | `extension/icons/`, `Store Upload/2-Store-listing/Icons/`, `site/` |
| `icon.svg` | vector master | `make-icons.py` | `assets/` |
| `promo-small-440x280.png` | 440×280 | `make-promo.py` | `Store Upload/2-Store-listing/Promo/` |
| `promo-marquee-1400x560.png` | 1400×560 | `make-promo.py` | `Store Upload/2-Store-listing/Promo/` |
| `01`–`05` screenshots | 1280×800 | `make-screenshots.py` | `screenshots/`, `Store Upload/2-Store-listing/Screenshots/` |
| `06`–`08` screenshots | 1280×800 | `make-screenshots.py` | `Store Upload/2-Store-listing/Extras/` — beyond the store's cap of 5 |
